  ...
  return (
    <div className="bg-yellow-100 text-black font-serif py-8 sm:py-10">
      <div className="max-w-3xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl sm:text-4xl md:text-6xl font-bold mb-6" style={{ fontFamily: 'Abhaya Libre, sans-serif' }}>
          Our Services
        </h1>

        <div className="mb-8 sm:mb-12 text-left">
          <h2 className="text-lg sm:text-xl font-medium mb-4 font-aclonica">
        ...
        <div className="text-left">
          <h2 className="text-lg sm:text-xl font-medium mb-4 font-aclonica">To the brands:</h2>
